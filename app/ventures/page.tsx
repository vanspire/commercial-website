...
export default function VenturesPage() {
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    "name": "Vanspire Ventures | Technology & Multi-Sector Brand Group",
    "description": "Vanspire operates through focused, high-conviction ventures. Technology is our active vertical.",
    ...
    <>
      ...
      <section className="relative pt-40 pb-0 md:pt-52 overflow-hidden bg-[#060608]">
        <div className="container-site pb-24 md:pb-32">
          ...
          <MotionWrapper delay={0.1}>
            <h1 className="text-[clamp(2.5rem,6vw,5.5rem)] font-light tracking-[-0.04em] text-white leading-[1.02] mt-4 mb-8 max-w-4xl">
              One Strategic Group.<br />
              <em className="not-italic text-white/40">Multiple Enterprise Sectors.</em><br />
              Uncompromising Standards.
            </h1>
          </MotionWrapper>
          <MotionWrapper delay={0.2}>
            <p className="text-[17px] font-light text-white/50 max-w-2xl leading-[1.85]">
              Vanspire is not a single-purpose entity. As a future-focused group, we deploy concentrated capital, engineering expertise, and strategic brand vision into high-conviction tech ventures. From advanced digital marketing initiatives to enterprise-grade software development companies under our wing, each division operates with deep independence while compounding the shared, rigorous infrastructure of the entire group.
            </p>
          </MotionWrapper>
        </div>
        <div className="w-full h-[400px] md:h-[500px] overflow-hidden relative">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#060608] via-transparent to-transparent z-[1]" />
        </div>
      </section>
      ...
      <section className="section-pad bg-white">
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <MotionWrapper className="lg:col-span-5 relative h-[320px] w-full">
              <Image
            ...
            <MotionWrapper delay={0.15} className="lg:col-span-7 flex flex-col justify-center">
              ...
              <p className="text-[16px] font-light text-brand-muted leading-[1.85] mb-6">
                The Technology venture is Vanspire&apos;s primary, fully operational vertical. We are recognized as the best software solutions and website development company driving large-scale digital transformations. We engineer custom enterprise mobile apps, high-performance web platforms, sophisticated scalable cloud infrastructures, and seamlessly integrated IoT systems. This vertical anchors the group with unmatched digital operational ability.
              </p>
              <div className="flex flex-wrap gap-2 mb-8">
                {['Enterprise Web Development', 'Mobile Applications', 'Cloud Architecture', 'IoT Integrations', 'Digital Transformation', 'Performance Marketing'].map((tag) => (
